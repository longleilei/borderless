...
import RMBDepositModal from "containers/modals/deposit/RMBDepositModal";
import RMBTransferModal from "containers/modals/transfer/RMBTransferModal";
...
import RMBAccount from "containers/account/RMBAccount";
...
function RMBHome() {
    ...
    return (
        <>
            <RMBDepositModal open={depositModalState} />
            <RMBTransferModal open={transferModalState} />
...
export default React.memo(RMBHome);
