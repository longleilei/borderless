...
import SGDDepositModal from "containers/modals/deposit/SGDDepositModal";
import SGDTransferModal from "containers/modals/transfer/SGDTransferModal";
...
import SGDAccount from "containers/account/SGDAccount";
...
function SGDHome() {
    ...
    return (
        <>
            <SGDDepositModal open={depositModalState} />
            <SGDTransferModal open={transferModalState} />
...
export default React.memo(SGDHome);
