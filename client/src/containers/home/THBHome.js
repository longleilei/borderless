...
import THBDepositModal from "containers/modals/deposit/THBDepositModal";
import THBTransferModal from "containers/modals/transfer/THBTransferModal";
...
import THBAccount from "containers/account/THBAccount";
...
function THBHome() {
    ...
    return (
        <>
            <THBDepositModal open={depositModalState} />
            <THBTransferModal open={transferModalState} />
...
export default React.memo(THBHome);
