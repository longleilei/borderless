...
import USDDepositModal from "containers/modals/deposit/USDDepositModal";
import USDTransferModal from "containers/modals/transfer/USDTransferModal";
...
import USDAccount from "containers/account/USDAccount";
...
function USDHome() {
    ...
    const ledgerConnectModalState = useSelector(
        selectModalState("ledgerConnectModal")
    );
    ...
    return (
        <>
            <USDDepositModal open={depositModalState} />
            <USDTransferModal open={transferModalState} />
            <ExitModal open={exitModalState} />
            <MergeModal open={mergeModalState} />
            <LedgerConnect
                open={
                    walletMethod === "browser" ? ledgerConnectModalState : false
                }
            />
...
export default React.memo(USDHome);
