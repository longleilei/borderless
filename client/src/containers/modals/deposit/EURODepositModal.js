...
import EUROInputStep from "./EUROsteps/EUROInputStep";
import EUROApproveStep from "./EUROsteps/EUROApproveStep";

const ETH = networkService.OmgUtil.transaction.ETH_CURRENCY;

function EURODepositModal({ open }) {
...
export default React.memo(EURODepositModal);
