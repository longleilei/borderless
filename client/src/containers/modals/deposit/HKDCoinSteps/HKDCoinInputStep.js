...
function HKDCoinInputStep({
    ...
    const [activeTab, setActiveTab] = useState("HKD Coin");
    ...
    async function depositETH() {
        if (value > 0 && tokenInfo) {
            ...
            if (res) {
                ...
                dispatch(openAlert("HKD Coin deposit submitted."));
                handleClose();
            }
        }
    }
    ...
    return (
        <>
            ...
            <Tabs
                ...
                onClick={(i) => {
                    i === "HKD Coin" ? setCurrency(ETH) : setCurrency("");
                    setActiveTab(i);
                }}
                activeTab={activeTab}
                tabs={["EUR", "ERC20"]}
