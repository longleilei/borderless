...
import HKDInputStep from "./HKDsteps/HKDInputStep";
import HKDApproveStep from "./HKDsteps/HKDApproveStep";

const ETH = networkService.OmgUtil.transaction.ETH_CURRENCY;

function HKDDepositModal({ open }) {
...
export default React.memo(HKDDepositModal);
