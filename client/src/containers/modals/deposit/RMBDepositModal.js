...
import RMBInputStep from "./RMBsteps/RMBInputStep";
import RMBApproveStep from "./RMBsteps/RMBApproveStep";

const ETH = networkService.OmgUtil.transaction.ETH_CURRENCY;

function RMBDepositModal({ open }) {
...
export default React.memo(RMBDepositModal);
