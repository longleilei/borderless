...
import SGDInputStep from "./SGDsteps/SGDInputStep";
import SGDApproveStep from "./SGDsteps/SGDApproveStep";

const ETH = networkService.OmgUtil.transaction.ETH_CURRENCY;

function SGDDepositModal({ open }) {
...
export default React.memo(SGDDepositModal);
