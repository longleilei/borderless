...
import THBInputStep from "./THBsteps/THBInputStep";
import THBApproveStep from "./THBsteps/THBApproveStep";

const ETH = networkService.OmgUtil.transaction.ETH_CURRENCY;

function THBDepositModal({ open }) {
...
export default React.memo(THBDepositModal);
