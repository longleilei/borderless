...
import USDInputStep from "./USDsteps/USDInputStep";
import USDApproveStep from "./USDsteps/USDApproveStep";

const ETH = networkService.OmgUtil.transaction.ETH_CURRENCY;

function USDDepositModal({ open }) {
...
export default React.memo(USDDepositModal);
