...
function USDApproveStep({ onClose, currency, value, tokenInfo }) {
            ...
            {allowance &&
                ...
                new BN(allowance).lt(new BN(weiAmount)) && (
                    <>
                        ...
                        <p>
                            You will be prompted with 2 approval requests. One
                            to reset the allowance to 0, and another for the new
                            amount.
                        </p>
                        {renderGasPicker}
                        <div className={styles.buttons}>
...
export default React.memo(USDApproveStep);
